...
class UsuariosController extends AppController {
    ...
    public function saveProfile() {
        ...
        if ($this->request->is('post')) {
            ...
            if ($this->Usuario->save($data)) {
                ...
                $this->Usuario->saveField('completo', 1);
    ...
    public function contactar() {
        if (AppController::checkAuth()) {
            ...
            $date = date('Y-m-d G:i:s', time() - 3600 * 5);
            ...
            if ($user["telefono1"] !== null && $user["telefono1"] !== "") {
            ...
            }if ($user["telefono2"] !== null && $user["telefono2"] !== "") {
                $html.='<div class="profile-info-row">
            ...
            if ($user["telefono3"] !== null && $user["telefono3"] !== "") {
                $html.='<div class="profile-info-row">
    ...
    public function seguir() {
        if (AppController::checkAuth()) {
            ...
            return new CakeResponse(array('body' => json_encode(array('title' => '¡Haz empezado a seguir a ' . $usrname . ' ' . $usr2name . '!', 'text' => 'Recibirás su actividad en tu linea del conocimiento', 'avatar' => $avatar)), 'status' => 200));
        } else {
    ...
    ');
                ...
                $this->createUser($email, $pass, $rol, $user);
            }
        }
