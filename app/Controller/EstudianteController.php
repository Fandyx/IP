 ...
 */
	...
	public function profile() {
		...
		$this->set('u_area',  
		$this->UsuarioArea->query("SELECT * FROM Instaprofe.ip_usuario inner join ip_usuario_area on ip_usuario_area.usuario=ip_usuario.id inner join ip_area on ip_usuario_area.area=ip_area.id where ip_usuario.id=".$user['id']." AND ip_area.id<=31"));
        $this->set('u_tags',  
