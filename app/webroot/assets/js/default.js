...
function autoCompleteUserSearch() {
    if ($('.user_search').autocomplete().data("ui-autocomplete") !== undefined) {
        $('.user_search').autocomplete({source:
                            ...
                            jQuery.ajax({
                                ...
                                success: function(data) {
                                    ...
                                    $.each(data.users, function() {
                                        ...
                                        //var html = '<img src="' + src + '" alt="avatar"><div>' + nombre + '</div><div>' + ciudad + '</div><div>' + tipo + '</div>'
                                        ...
                                        var html = '\
                                <a href="../Usuarios/profile?uid=' + usr.id + '" class="padding-0"><div class="dd-handle margin-0">\
                    ...
                    }, minLength: 3, appendTo: "#search_auto",
            select: function(event, ui)
            {
                return false;
            }
        }).data("ui-autocomplete")._renderItem = function(ul, item) {
            return $("<li class='dd-item' data-id='1'></li>")
