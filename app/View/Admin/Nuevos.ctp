...
the lightweight, feature-rich and easy to use admin template.
        ...
        <div class="row">
            ...
            <div class=" infobox-container">
                ...
                <div class="space-6"></div>
                <div class="btn_tables" id="reg_users"><span>+</span> Usuarios Nuevos con perfil completado</div>
                <table id="tabla_users" class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        foreach ($registrados as $row) {
                            ...
                            echo "<tr><td class='capitalize'>$nombre</td><td>$apellido</td><td>$email</td><td>$tipo</td><td>$fecha</td><td>$ciudad</td></tr>";
                        }
                        ?>
