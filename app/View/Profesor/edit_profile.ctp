                                                        ...
                                                        <div id="edit-basic" class="tab-pane in active">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-xs-12 col-sm-8">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label class="col-sm-4 control-label no-padding-right"  for="direccion">Direccion</label>

                                                                        <div class="col-sm-8">
                                                                            <input class="col-xs-12 col-sm-10" type="text" name="direccion" id="direccion" required placeholder="Direccion" value="<?=$user["direccion"]?>" />
                                                                        </div>
                                                                    </div>
                                                                    <div class="space-4"></div>
                                                                    <div class="form-group">
